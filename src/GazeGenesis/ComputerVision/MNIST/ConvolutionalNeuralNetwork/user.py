...
from GazeGenesis.ComputerVision.MNIST.DataSetLoader import LOADER
from GazeGenesis.ComputerVision.MNIST.ConvolutionalNeuralNetwork.model import CNN
...
class User:
    def __init__(self, in_channels: int = 1, num_classes: int = 10, learning_rate: float = 1e-3, train_batch_size: int = 64, test_batch_size: int = 64):
        ...
        self.model = CNN(in_channels = in_channels, num_classes = num_classes).to(self.device)
